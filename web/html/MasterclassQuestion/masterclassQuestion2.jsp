<%-- 
    Document   : masterclassQuestion2
    Created on : 31-dec-2014, 13:37:24
    Author     : Arne
--%>
...
Na een paar seconden verschijnt er een lange lijst met allerlei eiwitten die overeenkomen. <br/>
Bekijk de bovenste twee van de lijst en zoek bijvoorbeeld via google op<br/>
wat die eiwitten doen en waar ze vandaan komen. <br/>
Met name de wetenschappelijke naam van het organisme waar ze uit komen is van belang.<br/>
Gebruik wikipedia en Google om meer informatie over de mummy te vinden.<br/>
<br/>

<h1>Opdracht 2C</h1>

Maak nu een korte presentatie over wat je nu weet van de mummy. Hier kun je Impress voor gebruiken:<br/><br/>
- klik op Applications<br/>
- klik op Office<br/>
- klik op OpenOffice.org Presentation<br/><br/>
<button id="previous_question_button">Vorige vraag</button>
